...
const PROJECTS: Project[] = [
  {
    id: "aoa-togo",
    titleKey: "projects.aoaTogo.title",
    sectorKey: "projects.aoaTogo.sector",
    clientKey: "projects.aoaTogo.client",
    descriptionKey: "projects.aoaTogo.description",
    featuresKey: "projects.aoaTogo.features",
  ...
  {
    id: "jeunesse-plus",
    titleKey: "projects.jeunessePlus.title",
    sectorKey: "projects.jeunessePlus.sector",
    clientKey: "projects.jeunessePlus.client",
    descriptionKey: "projects.jeunessePlus.description",
    featuresKey: "projects.jeunessePlus.features",
  ...
  {
    id: "elycha",
    titleKey: "projects.elycha.title",
    sectorKey: "projects.elycha.sector",
    clientKey: "projects.elycha.client",
    descriptionKey: "projects.elycha.description",
    featuresKey: "projects.elycha.features",
    tags: ["Laravel", "Flutter", "Firebase", "MySQL"],
  ...
  {
    id: "golden-group",
    titleKey: "projects.goldenGroup.title",
    sectorKey: "projects.goldenGroup.sector",
    clientKey: "projects.goldenGroup.client",
    descriptionKey: "projects.goldenGroup.description",
    featuresKey: "projects.goldenGroup.features",
  ...
  {
    id: "muslim-togo",
    titleKey: "projects.muslimTogo.title",
    sectorKey: "projects.muslimTogo.sector",
    clientKey: "projects.muslimTogo.client",
    descriptionKey: "projects.muslimTogo.description",
    featuresKey: "projects.muslimTogo.features",
  ...
  {
    id: "groupe-cat",
    titleKey: "projects.groupeCat.title",
    sectorKey: "projects.groupeCat.sector",
    clientKey: "projects.groupeCat.client",
    descriptionKey: "projects.groupeCat.description",
    featuresKey: "projects.groupeCat.features",
