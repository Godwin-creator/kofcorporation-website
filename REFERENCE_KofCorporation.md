...
## 2. Coordonnées & Mentions Légales
...
- **Description** : Formation en développement web, mobile et outils numériques
- **Plateforme** : academy.kofcorporation.com
- **Formats** : Présentiel · En ligne · Hybride
- **Public cible** : Étudiants · Professionnels en reconversion · Équipes d'entreprises
...
| **JeunessePlus** | Santé | Jhpiego | Laravel, Flutter, Firebase, MySQL | Éducation sexuelle & reproductive, quiz, forum, ligne verte | jeunesse-plus.com | ✅ |
| **Elycha** | Immobilier / Auto | Elycha | Laravel, Flutter, Firebase, MySQL | Annonces immo & auto, favoris, notifications temps réel | elycha.com | ✅ |
| **Golden Group Technologies** | Services tech | Golden Group Technologies SARL | React, Java Spring Boot, PostgreSQL | Centre d'appel, étude de marché, formation commerciale | goldengrouptechnologies.com | ✅ |
...
|---|---|---|
| AIESEC | AIESEC | ONG / Leadership jeunesse |
| Jhpiego | Jhpiego (Johns Hopkins University Affiliate) | Santé internationale |
| UNDP | Programme des Nations Unies pour le Développement | Institution internationale |
| SamanVoyage | SamanVoyage | Tourisme / Transport |
...
## 7. Chiffres Clés (propositions à valider en présentation)
...
| Membre | Rôle | LinkedIn | Photo HD |
|---|---|---|---|
| **Omar Farouk KOUGBADA** | Fondateur & CEO | [À compléter] | [À fournir] |
| [Membre 2] | [À compléter] | [À compléter] | [À fournir] |
| [Membre 3] | [À compléter] | [À compléter] | [À fournir] |

---

## 9. Structure des Pages (proposition)

Inspirée de [Yield Studio](https://www.yieldstudio.fr/) (structure) et [Theodo](https://www.theodo.com/) (design).
...
│   ├── Projets mis en avant (via Sanity)
│   ├── Témoignages clients (via Sanity)
│   └── CTA final
│
├── /services
...
│   └── /services/formations
│
├── /realisations          ← Portfolio enrichi (via Sanity)
├── /qui-sommes-nous       ← Équipe, histoire, valeurs
├── /contact               ← Formulaire + carte + reCAPTCHA v3
...
## 12. Assets disponibles

| Asset | Emplacement | Format | Statut |
|---|---|---|---|
...
|---|---|---|---|
| Titres hero & sections | **Inter Tight** | 700 (hero) / 600 (sections) | H1, H2, taglines |
...
### Palette de couleurs
Extraite du site actuel (à affiner via DevTools) et adaptée pour les deux modes :

| Token | Mode clair | Mode sombre | Usage |
|---|---|---|---|
| `--color-primary` | `#2F3974` (bleu profond) | `#E8F0FE` | Texte principal, titres |
| `--color-accent` | `#0CACE8` (cyan lumineux) | `#0CACE8` | CTA, liens, hover |
| `--color-bg` | `#F8F9FA` | `#1A1E3A` | Fond de page |
| `--color-surface` | `#FFFFFF` | `#2C417A` | Cards, sections alternées |
| `--color-surface-alt` | `#EEF2FF` | `#1A2235` | Sections secondaires |
| `--color-text` | `#1A1A2E` | `#E2E8F0` | Corps de texte |
...
::-webkit-scrollbar-thumb:hover { background: #1A85BD; }
```

### Icônes
| Élément | Règle / Solution |
|---|---|
| **Bibliothèque d'icônes** | **Lucide React** (`lucide-react`) |
| **Règles strictes** | • **Pas d'emojis** dans l'UI institutionnelle<br>• **Pas de Font Awesome** ni de librairies d'icônes tierces hétérogènes |
...
- Outil : `next-intl` (recommandé avec App Router)
- Structure : `/fr/...` et `/en/...` ou via middleware selon locale détectée
